...
export const parentInfoStep: Step = {
  ...
  description: "List the minor's legal parents and contact information.",
  fields: [
    "parent1FullName",
    "parent1Phone",
    "parent1Email",
